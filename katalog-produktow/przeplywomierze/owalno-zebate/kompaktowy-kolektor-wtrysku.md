...
permalink: /p/przeplywomierze/owalno-zebate/kompaktowy-kolektor-wtrysku-z-dodatkiem-do-bloku-AIM/
---
...
»
<a href="/p/przeplywomierze/owalno-zebate/kompaktowy-kolektor-wtrysku-z-dodatkiem-do-bloku-AIM/">Kompaktowy kolektor wtrysku z dodatkiem do bloku AIM</a>
</li>
</ul>

            <h2>Kompaktowy kolektor wtrysku z dodatkiem do bloku AIM</h2>
            <div class="image-right">
              <img alt="Do_zywnosci" src="/assets/images/katalog_produktow/przeplywomierze/owalno-zebate/kolektor-wtrysku.jpg" style="width: 200px;">

            </div>
            
            <p class="sheet">
              <a href="/assets/documents/przeplywomierze/owalno-zebate/kompaktowy-kolektor-wtrysku-z-dodatkiem-do-bloku-AIM/aim-block-data-sheet.pdf">Karta katalogowa (angielski)</a>
            </p>
            <p class="sheet">
              <a href="/assets/documents/przeplywomierze/owalno-zebate/kompaktowy-kolektor-wtrysku-z-dodatkiem-do-bloku-AIM/aim-owners-manual.pdf">Instrukcja obsługi (angielski)</a>
            </p>
          </div>
        </div>
      </div>

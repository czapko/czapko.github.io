...
permalink: /p/przeplywomierze/wirnikowe/sdi-hot-tap/
---
...
»
<a href="/p/przeplywomierze/wirnikowe/sdi-hot-tap">SDI Hot-Tap</a>
</li>
</ul>
            ...
            <p>
              Seria czujników SDI oferuje niezrównaną możliwość dla pomiaru przepływu w zamkniętych rurociągach. <br><br> Układ wirnika znakomicie sprawdza się w aplikacji monitorowania lub regulacji przepływu jak również w aplikacjach dozowania. Przepływomierz może być użyty w rurociągach od 1,5” do 48”. <br><br> Czujnik może być użyty w pomiarach przepływu wody a w wykonaniu ze stali nierdzewnej do cieczy korozyjnych w wysokiej temperaturze i ciśnieniu. Opcjonalnie dostępne są wersje umożliwiające pomiar w dwóch kierunkach jak również wersje zasilane bateryjnie. <br><br> Czujniki Hot-Tap cechują się dodatkowym zaworem odcinającym pozwalającym na montaż w rurociągu który nie może zostać opróżniony w celu zamontowania czujnika.
            </p>
            
            <p class="sheet">
              <a href="/assets/documents/przeplywomierze/wirnikowe/SDI_Hot_tap_flow_sensor_1_pl.pdf">Karta katalogowa</a>

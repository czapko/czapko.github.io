...
»
<a href="/p/przeplywomierze/turbinowe/blancett-sup-sup-flow-monitor-b3000">Blancett&lt;sup&gt;®&lt;/sup&gt; Flow Monitor B3000</a>
</li>
</ul>

            <h2>Blancett<sup>®</sup> Flow Monitor B3000</h2>
            <div class="image-right">
              <img alt="B3000" src="/assets/images/katalog_produktow/przeplywomierze/turbinowe/B3000.png">

            </div>
            <p>
              Nowa seria monitorów B3000 to elastyczne, łatwe w użyciu liczniki elektroniczne. Seria ta oferuje więcej funkcji w stosunku do serii B2800. </p><ul><li>Możliwość ustawiania alarmów,</li><li>Większa kontrola oraz wskazania wartości przepływu,</li><li>Zaawansowane opcje komunikacji pozwalające na podłączenie przepływomierzy do sieci lub liczników zewnętrznych oraz do systemów automatyzacji procesów,</li><li>Opcja zasilania z baterii solarnej oraz pętlą 4-20 mA pozwalają na zdolność do montażu w oddalonych miejscach zapewniając odczyt nawet przy utracie zasilania przy użyciu baterii o&nbsp;żywotności do 8 lat,</li><li>Wyświetlacz wskazujący jednocześnie natężenie przepływu oraz objętość,</li><li>Różne opcje montażu,</li></ul>
            <p></p>
            
            <p class="sheet">
              <a href="/assets/documents/przeplywomierze/turbinowe/DB_Blancett_B3000_Flow_monitor_pl.pdf">Karta katalogowa</a>

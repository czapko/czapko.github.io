...
permalink: /p/przeplywomierze/turbinowe/blancett-sup-sup-floclean/
---
...
»
<a href="/p/przeplywomierze/turbinowe/blancett-sup-sup-floclean">Blancett&lt;sup&gt;®&lt;/sup&gt; FloClean™</a>
</li>
</ul>

            <h2>Blancett<sup>®</sup> FloClean™</h2>
            ...
            <p>
              Seria przepływomierzy turbinowych FloClean™ jest przeznaczona do aplikacji spożywczych, napojów oraz farmaceutyki. Konstrukcja wykonana ze stali 316L charakteryzuje się wysoką trwałością a jednocześnie wysoką dokładnością i powtarzalnością pomiaru.<br><br> Materiały użyte w konstrukcji przepływomierza FloClean™ są zgodne z wymaganiami FDA i są wykonane przy użyciu najnowszych technologii polerowania.<br><br> Seria FloClean™ B16C posiada wyjmowane łożyskowanie co pozwala na łatwe czyszczenie oraz inspekcję. Spełnia to standardy 3-A numer 28-04 odnośnie COP i SOP. Symbol 3-A jest umieszczany na korpusie przepływomierza. FloClean™ wytwarza na wyjściu sygnał sinusoidalny proporcjonalny do wolumetrycznego natężenia przepływu i są całkowicie kompatybilne z licznikami serii B2800/B3000 oraz inteligentnymi przetwornikami serii Blancett<sup>®</sup>. Ponadto mogą być podłączane do innych rejestratorów, PLC i komputerów.
            </p>
            
            <p class="sheet">
              <a href="/assets/documents/przeplywomierze/turbinowe/DB_Blancett_FloClean_Sanitary_turbine_flow_meter_pl.pdf">Karta katalogowa</a>

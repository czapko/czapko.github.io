...
»
<a href="/p/przeplywomierze/zwezkowe-i-roznicowo-cisnieniowe/preso-venturi-ssl">Preso® Venturi SSL</a>
</li>
</ul>

            <h2>Preso® Venturi SSL</h2>
            <div class="image-right">
              <img alt="Csm_venturi_ssl" src="/assets/images/katalog_produktow/przeplywomierze/zwezkowe-i-roznicowo-cisnieniowe/csm_Venturi_SSL.png">

            </div>
            <p>
              Budowa przepływomierza Preso® Venturi zapewnia długotrwałą dokładność i&nbsp;mały, stały spadek ciśnienia dzięki unikalnemu wykonaniu "low-loss" redukując tym samym koszty obsługi i&nbsp;serwisu. Przepływomierze Preso® Venturi mogą zostać zastosowane do aplikacji o&nbsp;wysokiej temperaturze i&nbsp;ciśnieniu, które często ograniczają użycie innych technologii pomiaru. Wszystkie modele mogą być również wyposażone w&nbsp;czujniki RTD i&nbsp;przetworniki pozwalające na uzyskanie wartości przepływu masy.Przepływomierze Preso® Venturi mogą być montowane w&nbsp;dowolnej pozycji. Przeznaczone są do zastosowania w&nbsp;szerokim spektrum aplikacji w&nbsp;branży wodno-ściekowej, przemysłowej, HVAC oraz spożywczej.</p><p><strong>Media:</strong><br>Chemia, petrochemia, oleje, media farmaceutyczne, gazy, woda, inne.</p><p><strong>Zakres pomiaru:</strong><br>1 do 380 000 l/min</p><p><strong>Temperatura:</strong><br>0 do 426 °C</p><p><strong>Ciśnienie:</strong><br>0 do 69 bar
            </p>

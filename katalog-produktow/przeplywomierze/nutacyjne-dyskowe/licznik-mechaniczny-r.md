...
permalink: /p/przeplywomierze/nutacyjne-dyskowe/licznik-mechaniczny-r/
---
...
»
<a href="/p/przeplywomierze/nutacyjne-dyskowe/licznik-mechaniczny-r">Licznik mechaniczny R</a>
</li>
</ul>

            <h2>Licznik mechaniczny R</h2>
            <div class="image-right">
              <img alt="Mech_register" src="/assets/images/katalog_produktow/przeplywomierze/nutacyjne-dyskowe/mech_register.png">

            </div>
            <p>
              Licznik mechaniczny R, jest prostym licznikiem przeznaczonym do stosowania z przepływomierzami serii RCDL. Posiada wskazówkowy licznik oraz sumator całkowity bez możliwości kasowania. Całość licznika jest zamknięta w szczelnej hermetycznej obudowie ze stopniem ochrony IP68
            </p>
            
            <p class="sheet">
              <a href="/assets/documents/przeplywomierze/nutacyjne-dyskowe/IND_RCDLR_Register_Datenblatt_0612_pl.pdf">Karta katalogowa</a>

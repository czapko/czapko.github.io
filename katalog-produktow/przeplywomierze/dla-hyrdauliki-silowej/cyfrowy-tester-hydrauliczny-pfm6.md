...
permalink: /p/przeplywomierze/dla-hydrauliki-silowej/cyfrowy-tester-hydrauliczny-pfm6/
---
...
»
<a href="/p/przeplywomierze/dla-hydrauliki-silowej/cyfrowy-tester-hydrauliczny-pfm6">Cyfrowy tester hydrauliczny PFM6</a>
</li>
</ul>

            <h2>Cyfrowy tester hydrauliczny PFM6</h2>
            <div class="image-right">
              <img alt="Hd_pmf6_4c" src="/assets/images/katalog_produktow/przeplywomierze/dla-hydrauliki-silowej/HD_PMF6_4C.png">

            </div>
            <p>
              Seria testerów PFM6 to kompaktowe, lekkie, przenośne urządzenia do szybkiej diagnostyki stacjonarnych i&nbsp;przenośnych układów hydraulicznych. Testery charakteryzują się laboratoryjną dokładnością i&nbsp;dostarczają jednoczesnego odczytu przepływu, ciśnienia i&nbsp;temperatury.  <br><br>Cechy: </p><ul><li>pięć zakresów pomiaru,</li><li>duży wyświetlacz LCD,</li><li>dostępny z&nbsp;przyłączami SAE lub BSPP,</li><li>ciśnienie robocze do 414 bar,</li><li>temperatura robocza do +150°C,</li><li>dokładność ±1% pełnej skali,</li><li>powtarzalność ±0,2%.</li></ul>
            <p></p>
            
            <p class="sheet">
              <a href="/assets/documents/przeplywomierze/dla-hydrauliki-silowej/DB_Hedland_Flo-Tech_PFM6_Digital_port_hydr_tester_en.pdf">Karta katalogowa</a>

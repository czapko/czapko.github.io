...
permalink: /p/zawory-regulacyjne/male-zawory-regulacyjne/pozycjoner-blra-tlda/
---
...
»
<a href="/p/zawory-regulacyjne/male-zawory-regulacyjne/pozycjoner-blra-tlda">Pozycjoner BLRA/TLDA</a>
</li>
</ul>

            <h2>Pozycjoner BLRA/TLDA</h2>
            <div class="image-right">
              <img alt="Blra" src="/assets/images/katalog_produktow/zawory-regulacyjne/male-zawory-regulacyjne/BLRA.jpg">

            </div>
            <p>
              Pneumatyczny pozycjoner Badger Meter ze zintegrowanym aktuatorem. <br><br> Pozycjoner BLRA (Bottom Load Reverse Action) / TLDA (Top Load Direct Action) zapewnia szybką i precyzyjną regulację. Aktuator powinien być stosowoany w przypadku gdy wymagane są większe siły działania aktuatora przy stałym sygnale wejściowym 0,2 – 1,0 bar
            </p>

...
permalink: /p/zawory-regulacyjne/male-zawory-regulacyjne/aktuator-pneumatyczny-blra-ato/
---
...
»
<a href="/p/zawory-regulacyjne/male-zawory-regulacyjne/aktuator-pneumatyczny-blra-ato">Aktuator pneumatyczny BLRA ATO </a>
</li>
</ul>

            <h2>Aktuator pneumatyczny BLRA ATO</h2>
            <div class="image-right">
              <img alt="Blra_ato" src="/assets/images/katalog_produktow/zawory-regulacyjne/male-zawory-regulacyjne/BLRA_ATO.jpg">

            </div>
            <p>
              Aktuator z pozycjonerem. Aktuator AC-OP posiada zintegrowany pozycjoner pneumatyczny BLRA specjalnie skonstruowany jako kompaktowe rozszerzenie dla zaworów ReCo<sup>®</sup>. <br><br> Pozycjoner BLRA (Bottom Load Reverse Action) zapewnia szybką i precyzyjną regulację przez wysoką precyzję pozycjonowania, która może być zapewniona niezależnie od zmian ciśnienia medium. <br><br> Ten aktuator powinien być stosowany w przypadku gdy potrzebna jest większa siła zamykająca zawór przy niezmiennym sygnale wejściowym 0,2 – 1,0 bar
            </p>
            
            <p class="sheet">
              <a href="/assets/documents/zawory-regulacyjne/male-zawory-regulacyjne/RCV_ACOP_DB_02_0869_pl.pdf">Karta katalogowa</a>
